...
documents = [
    ...
    {
        "name": "The Expanse",
        "description": "A space opera following the crew of a ship as they navigate political intrigue and alien threats.",
...
if __name__ == "__main__":
    ...
    print("\nAlien Invasion Books from 2000:")
    alien_year2000()
